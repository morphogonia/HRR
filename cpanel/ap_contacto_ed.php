...
$id = 1;
$texto=utf8_decode($_POST['statement']);

mysql_query("UPDATE tb_contacto SET texto = '$texto' WHERE id = '$id'", $link);
print '<meta http-equiv="refresh" content="1; url=ap_contacto.php">';
?>
