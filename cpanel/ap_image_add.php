...
if($filesize1 && $filesize2 != 0) {
	mysql_query("INSERT INTO tb_images VALUES('', '$f1','$f2','$description', '$ord', '$cat')", $link);
	print '<meta http-equiv="refresh" content="1; url=ap_serie.php?id='.$cat.'">';
} else {
