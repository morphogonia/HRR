...
$id = 1;
$content = @mysql_query("SELECT * FROM tb_bio WHERE id = '$id'");
...
<h3>Estás editando tu biografía</h3>
<h3>Actualiza la información y cuando hayas terminado da click en editar</h3>

<form enctype="multipart/form-data" id="login" action="ap_humbertorios_ed.php" method="post">
	<label>Bio:</label>
