...
$anho=utf8_decode($_POST['anho']);
$epigrafe=utf8_decode($_POST['epigrafe']);
$statement=utf8_decode($_POST['statement']);

mysql_query("UPDATE tb_categorias SET title = '$titulo', dat = '$anho', epigrafe = '$epigrafe', statement = '$statement' WHERE id = '$id'", $link);
print '<meta http-equiv="refresh" content="1; url=ap_serie.php?id='.$id.'">';
?>
